...
export const CheckoutPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <button className="bg-cyan-600 text-white rounded px-4 py-2 w-fit shadow-[0_0_20px] shadow-cyan-500/20 disabled:opacity-50" onClick={onPlace} disabled={items.length===0 || (API_BASE && !customer)}>Place order</button>
    </div>
  )
}
